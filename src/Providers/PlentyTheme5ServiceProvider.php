...
namespace PlentyTheme5B2B\Providers;
...
use PlentyTheme5B2B\Contexts\ThemeNameSingleItemContext;

/**
 * Class PlentyTheme5B2BServiceProvider
 * @package PlentyTheme5B2B\Providers
 */
class PlentyTheme5B2BServiceProvider extends ServiceProvider
{
    const PRIORITY = 0;
    ...
    public function boot(Twig $twig, Dispatcher $dispatcher, ConfigRepository $config)
    {
        ...
        $enabledOverrides = explode(", ", $config->get("PlentyTheme5B2B.templates.override"));
        ...
        {
            //pluginApp(Container::class)->register('PlentyTheme5B2B::PageDesign.Partials.Header.NavigationList.twig', NavigationCacheSettings::class);
            //pluginApp(Container::class)->register('PlentyTheme5B2B::PageDesign.Partials.Header.SideNavigation.twig', SideNavigationCacheSettings::class);
            ...
            {
                $partial->set('head', 'PlentyTheme5B2B::PageDesign.Partials.Head');
            }

            if (in_array("header", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('header', 'PlentyTheme5B2B::PageDesign.Partials.Header.Header');
            }

            if (in_array("page_design", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('page-design', 'PlentyTheme5B2B::PageDesign.PageDesign');
            }

            if (in_array("footer", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('footer', 'PlentyTheme5B2B::PageDesign.Partials.Footer');
            }
        ...
        if (in_array("homepage", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Homepage.Homepage');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_content", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Category.Content.CategoryContent');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_view", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Category.Item.CategoryItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("basket", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Basket.Basket');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("checkout", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Checkout.CheckoutView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B5::Checkout.OrderConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("login", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Customer.Login');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("register", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Customer.Register');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Item.SingleItemWrapper');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("search", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::ItemList.ItemListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("my_account", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::MyAccount.MyAccountView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("wish_list", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::WishList.WishListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("contact", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Customer.Contact');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::OrderReturn.OrderReturnView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::OrderReturn.OrderReturnConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_rights", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::StaticPages.CancellationRights');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_form", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::StaticPages.CancellationForm');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("legal_disclosure", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::StaticPages.LegalDisclosure');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("privacy_policy", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::StaticPages.PrivacyPolicy');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("terms_conditions", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::StaticPages.TermsAndConditions');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::StaticPages.ItemNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("page_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::StaticPages.PageNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("newsletter_opt_out", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('PlentyTheme5B2B::Newsletter.NewsletterOptOut');
                return false;
            }, self::PRIORITY);
        }
        ...
        if(!empty($config->get("PlentyTheme5B2B.result_fields.override")))
        {
            $enabledResultFields = explode(", ", $config->get("PlentyTheme5B2B.result_fields.override"));
        }
        ...
        if(!empty($enabledResultFields))
        {
            $dispatcher->listen( 'IO.ResultFields.*', function(ResultFieldTemplate $templateContainer) use ($enabledResultFields)
            {
                ...
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_LIST_ITEM] = 'PlentyTheme5B2B::ResultFields.ListItem';
                }
                
                // Override single item view result fields
                if (in_array("single_item", $enabledResultFields) || in_array("all", $enabledResultFields))
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_SINGLE_ITEM] = 'PlentyTheme5B2B::ResultFields.SingleItem';
                }
                
                // Override basket item result fields
                if (in_array("basket_item", $enabledResultFields) || in_array("all", $enabledResultFields))
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_BASKET_ITEM] = 'PlentyTheme5B2B::ResultFields.BasketItem';
                }
                ...
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_AUTOCOMPLETE_ITEM_LIST] = 'PlentyTheme5B2B::ResultFields.AutoCompleteListItem';
                }
                
                // Override category tree result fields
                if (in_array("category_tree", $enabledResultFields) || in_array("all", $enabledResultFields))
                {
                    $templatesToOverride[ResultFieldTemplate::TEMPLATE_CATEGORY_TREE] = 'PlentyTheme5B2B::ResultFields.CategoryTree';
                }
